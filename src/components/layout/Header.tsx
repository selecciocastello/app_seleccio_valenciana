...
import { Menu, X, LogOut, LayoutDashboard, Users, ShieldAlert, Calendar, MapPin, Dumbbell, FileSpreadsheet, Settings } from 'lucide-react';
...
export const Header: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/seleccionados', label: t.selectedPlayers, icon: Users },
